...
(NULL, 'Verified Accounts I Follow', 
 'SELECT owner_username, username, displayName, followerCount, followingCount, heartCount, videoCount, avatar FROM profiles WHERE owner_username = ? AND is_following = 1 AND verified = 1;'),
